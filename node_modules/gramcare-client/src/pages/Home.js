...
const Home = () => {
  const features = [
    ...
    },
    {
      ...
      description: 'Communicate with the AI model via SMS for health queries and updates',
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
              No internet? No problem! Get health information and support directly through SMS.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link 
                to="/sms-setup" 
                className="inline-flex items-center justify-center px-8 py-4 bg-gradient-to-br from-purple-600 to-indigo-600 text-white font-semibold rounded-xl hover:from-purple-700 hover:to-indigo-700 transition-all duration-300 transform hover:scale-105 hover:shadow-lg group"
              >
